...
struct onnx_resolver_t resolver_default = {
    ...
    .op_BitCast = resolver_default_op_BitCast,
    ...
    .op_CausalConvWithState = resolver_default_op_CausalConvWithState,
    ...
    .op_CumProd = resolver_default_op_CumProd,
    ...
    .op_LinearAttention = resolver_default_op_LinearAttention,
    ...
    .op_ZipMap = resolver_default_op_ZipMap,
};
